            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item  ">
                                    <a href="component-accordion.html" class="submenu-link">Employee</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="component-alert.html" class="submenu-link">Trainee</a>

                                </li>


                                <li class="submenu-item  ">
                                    <a href="component-badge.html" class="submenu-link">Merit Rating</a>

                                </li>


                                <li class="submenu-item  ">
                                    <a href="component-breadcrumb.html" class="submenu-link">Retirement</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="component-button.html" class="submenu-link">Probation</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="component-card.html" class="submenu-link">Absen</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="component-carousel.html" class="submenu-link">Overtime</a>

                                </li>

                                <li class="submenu-item  ">
                                    <a href="component-card.html" class="submenu-link">Promosi</a>
                        ...
                        <li class="sidebar-title">Update</li>
